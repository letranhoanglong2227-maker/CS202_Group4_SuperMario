...
| `P2-EXTENT-001` | Explicit dynamic world extent | P0 | `IMPLIED_BY_CURRENT_GROUP4_DESIGN` | `TESTING` | `READY_WITH_STABLE_CONTRACT` | P1 camera consumption is the remaining gameplay gate | `CON-P1-P2-WORLD-EXTENT`, `CON-P1-P2-CAMERA` | Map-derived dynamic bounds are exposed only after load; source and runtime contract checks pass | 1/0/1/NA/0 |
| `P2-BOUNDS-001` | Player and world-edge bounds | P0 | `IMPLIED_BY_CURRENT_GROUP4_DESIGN` | `READY` | `READY_INDEPENDENT` | None; the tested P2 extent provider is available | `CON-P1-P2-WORLD-EXTENT` | Clamp/resolve left-right edges; preserve dynamic width; no window-derived limit | 0/0/0/0/0 |
| `P2-PIT-001` | Map-derived pit/death detection | P0 | `IMPLIED_BY_CURRENT_GROUP4_DESIGN` | `TESTING` | `READY_WITH_STABLE_CONTRACT` | P1/P3 fatal-respawn production flow remains | `CON-P1-P2-DEATH`, `CON-P1-P3-PLAYER-RESET` | Map-bottom plus one-cell margin emits one fatal callback and skips later contacts; source/runtime pass | 1/0/1/NA/0 |
| `P2-CLEANUP-001` | Off-world owned-object cleanup | P1 | `IMPLIED_BY_CURRENT_GROUP4_DESIGN` | `BLOCKED` | `BLOCKED_BY_OTHER_TASK` | P3 enemy/item inactive-removal predicates | `CON-P2-P3-ENEMY-REMOVAL` | Projectile world culling passes; enemy/item off-world cleanup still awaits P3 lifecycle APIs | 0/0/0/0/0 |
...
| `P2-LAVA-001` | Correct Lava death semantics | P0 | `REQUIRED_BY_PLAN` | `TESTING` | `READY_WITH_STABLE_CONTRACT` | P1 death transition is the remaining production gate | `CON-P1-P2-DEATH` | Small player dies once; Big/Fire downgrade without false death callback; source/runtime pass | 1/0/1/0/0 |
| `P2-ENV-001` | Pipe, Trampoline, and MovingBlock verification/integration | P1 | `REQUIRED_BY_PLAN` | `TESTING` | `READY_WITH_STABLE_CONTRACT` | Production visual/gameplay pass remains | `CON-P2-P4-BLOCK-COLLISION`, `CON-P2-P4-BLOCK-VISUAL-SIZE` | Pipe collider, Trampoline launch, MovingBlock endpoints/carry and parser registration pass focused runtime checks | 1/1/1/0/0 |
| `P2-PROJECTILE-001` | Cannon/Bullet/Rocket production collision and culling | P1 | `REQUIRED_BY_PLAN` | `TESTING` | `READY_WITH_STABLE_CONTRACT` | P3 boss/fire request providers and production visual/gameplay pass remain | `CON-P1-P2-DEATH`, `CON-P2-P3-PROJECTILE-SPAWN` | Owned spawn, target loss, block hit, lifetime, off-world culling and once-only player damage pass | 1/0/1/0/0 |
| `P2-WINFLAG-001` | Base-anchor WinFlag semantics and completion | P0 | `REQUIRED_BY_PLAN`; `IMPLIED_BY_CURRENT_GROUP4_DESIGN` | `TESTING` | `READY_WITH_STABLE_CONTRACT` | P1 deferred win transition and visual/gameplay pass remain | `CON-P1-P2-COMPLETION` | Base-anchor geometry, bounded slide and deferred exactly-once completion pass runtime checks | 1/0/1/0/0 |
...
**P2 evidence update — 2026-08-28:** implementation commit `419d03d`; `SuperMario` and `Person2RuntimeContracts` build with C++20/SFML 3.1; CTest passes `1/1`; the fresh runtime executable reports `57 PASS / 0 FAIL`. `TESTING` rows above deliberately remain short of `DONE` until their production integration and applicable visual/gameplay gates are recorded.
...
20 tasks: `P1-APP-001`, `P1-STATE-001`, `P1-MENU-001`, `P1-CAMERA-001`, `P1-EVENT-001`; `P2-BOUNDS-001`; `P3-FOUNDATION-001`, `P3-PLAYER-VISUAL-001`, `P3-PLAYER-STATE-001`, `P3-PLAYER-RESET-001`, `P3-GOOMBA-001`, `P3-KOOPA-001`, `P3-AIR-HERISS-001`, `P3-BOSS-001`, `P3-FACTORY-001`; `P4-ANIMATION-001`, `P4-BLOCK-SIZE-001`, `P4-QUESTION-BLOCK-001`, `P4-AUDIO-001`, `P4-GUI-001`.
...
18 tasks: `P1-SELECT-001`, `P1-GAME-001`, `P1-DEATH-001`, `P1-WIN-001`, `P1-PAUSE-001`; `P2-LOAD-001`, `P2-CLEANUP-001`, `P2-CONTACT-ENEMY-001`, `P2-CONTACT-ITEM-001`, `P2-VARIANT-WIRE-001`, `P2-NINE-LEVEL-001`; `P3-ITEM-001`, `P3-FIRE-001`; `P4-PAYLOAD-BLOCK-001`, `P4-HUD-001`, `P4-PERSISTENCE-001`, `P4-LEADERBOARD-001`, `P4-PACKAGE-001`.

### TESTING

6 tasks: `P2-EXTENT-001`, `P2-PIT-001`, `P2-LAVA-001`, `P2-ENV-001`, `P2-PROJECTILE-001`, `P2-WINFLAG-001`.
